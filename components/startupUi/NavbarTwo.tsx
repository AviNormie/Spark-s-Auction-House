...
export function NavbarTwo() {
  ...
  return (
    <>
      {/* Desktop Navbar */}
      <nav className="hidden md:flex fixed top-2 left-1/2 -translate-x-1/2 bg-black text-white rounded-full px-10 py-3 items-center justify-between shadow-lg w-fit max-w-full gap-10 z-50">
