...
export function Event() {
  ...
  return (
    <div className="relative h-screen w-full flex items-center justify-center bg-black p-4 md:p-0">
      {/* Background Image */}
      <div className="relative mx-4 md:mx-12 p-4 md:p-8 overflow-hidden rounded-lg md:rounded-[0.7rem]">
        ...
        <div className="relative w-full md:w-[100%] max-w-[1600px] flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10 text-white p-4 md:p-8">
          ...
          {/* Right Section (Logos + Details) */}
            ...
            <div className="flex justify-center gap-8 fade-in w-full max-w-[600px]">
              <Image src="/spark-logo.png" alt="Spark" width={180} height={180} className="w-36 md:w-36 h-auto" />
              <Image src="/hatchery-logo.png" alt="Bennett Hatchery" width={240} height={180} className="w-auto md:w-auto h-36" />
            </div>
